 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.onboarding.screen")
@ContextConfiguration(classes = {OnboardingApplication.class, UiTestAssistConfiguration.class})
