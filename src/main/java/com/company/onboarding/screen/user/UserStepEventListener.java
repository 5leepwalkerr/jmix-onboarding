...
public class UserStepEventListener {
    ...
    @EventListener
    public void onUserStepChangeBeforeCommit(EntityChangedEvent<UserStep> event){
        User user;
        if(event.getType()!=EntityChangedEvent.Type.DELETED){
            ...
            if(userId == null){
                throw new IllegalStateException("Cannot ger User from deleted UserStep");
            }
        ...
        else user.setOnboardingStatus(OnboardingStatus.IN_PROGRESS);
